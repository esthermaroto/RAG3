# Consejos sobre el banner del canal y la imagen de perfil

[Saltar al contenido principal](#hcfe-content)

[Ayuda de YouTube](/youtube)

[Iniciar sesión](https://accounts.google.com/ServiceLogin?hl=es&passive=true&continue=http://support.google.com/youtube/answer/12950272%3Fsjid%3D11557296865847177507-EU&ec=GAZAdQ)
...
[* Comunidad](/youtube/community?hl=es&help_center_link=CIC2lgYSOENvbnNlam9zIHNvYnJlIGVsIGJhbm5lciBkZWwgY2FuYWwgeSBsYSBpbWFnZW4gZGUgcGVyZmls)[* YouTube](//www.youtube.com/)
...
* [Centro de asistencia](/youtube/?hl=es)
* [Comunidad](/youtube/community?hl=es&help_center_link=CIC2lgYSOENvbnNlam9zIHNvYnJlIGVsIGJhbm5lciBkZWwgY2FuYWwgeSBsYSBpbWFnZW4gZGUgcGVyZmls)
...
YouTube te da la oportunidad de darte a conocer y mostrar quién eres, tus intereses, tu personalidad y todo lo que te apasiona. El contenido que produzcas cubrirá estos temas y te permitirá crear una marca para tu canal que sea reconocible por tu audiencia. La [marca de tu canal](/youtube/answer/10456525) también puede ayudarte a destacar y transmitir tu mensaje de forma clara.

El punto de partida es el nombre de tu canal, pero tu marca también consta de elementos visuales como la imagen de banner y la imagen de perfil.

Cuando vayas a elegir los elementos visuales de tu marca, hazte estas preguntas:

* **¿Quién eres** como creador?
* ¿Qué características te hacen **especial**?
* ¿Cómo refleja tu marca tus **valores** como creador y la comunidad que te apoya?
* ¿Hasta qué punto es **coherente** tu branding tanto online como offline?

![](//storage.googleapis.com/support-kms-prod/Ch5HG5RGzGnfHhvVSD93gdoEvWm5IPGUkOnS)

[*Simply Not Logical*](https://www.youtube.com/c/SimplyNotLogical/videos)  *utiliza un esquema de colores coherente en sus imágenes de perfil y de banner. En su imagen de banner, muestra la programación de sus emisiones en directo y los enlaces a sus redes sociales.*

Veamos cómo puedes expresar tu identidad de marca a través de tu imagen de perfil y tu imagen de banner.

[Diseñar una imagen de perfil de YouTube](//www.youtube.com/watch?v=s4sE7NyTvzs)
...
* La [**imagen de perfil**](/youtube/answer/2972003#zippy=%2Cchange-your-profile-picture) es el **logotipo o imagen distintiva** que representa a tu canal. Aparecerá en muchos sitios: en la página del canal, en tus comentarios y en la parte inferior derecha de los vídeos en la mayoría de los modos de reproducción. Te recomendamos que subas una imagen cuadrada o redonda.
* La [**imagen de banner**](/youtube/answer/10456525) es un espacio más grande para que **muestres de qué trata tu canal**. Recomendamos que las imágenes de banner tengan al menos 2560x1440 píxeles para que se vean de forma óptima en todos los dispositivos. Puedes crear la imagen de banner en tu software de edición de fotos favorito. [Canva](https://www.canva.com/) es un recurso muy utilizado para hacer banners.

![](//storage.googleapis.com/support-kms-prod/ih1aNrD8d75g0btyQYHFSpW3h7nwnxvRNPUU)

### Cosas que debes tener presentes

* Las marcas afianzadas son fáciles de recordar porque sus elementos visuales de marca tienen **un aspecto, un estilo y una voz coherentes**. Piensa en si están alineadas tus imágenes de perfil y de banner, y cómo expresan la identidad de tu canal. Asegúrate de que se integran con tu branding fuera de YouTube.
* Recuerda que los elementos de marca del canal deben cumplir las [Normas de la Comunidad](/youtube/answer/9288567) de YouTube.

### Recomendaciones

* Si sigues una programación de [subida](/youtube/answer/57407) regular, informa a tus fans sobre cuándo pueden volver a ver vídeos nuevos **añadiendo tu programación a la imagen de banner**.
* Tu imagen de banner y tu imagen de perfil pueden **evolucionar contigo**. Cambia los elementos visuales de tu canal cuando consideres que han cambiado tus valores o el mensaje que quieres transmitir.
* ¿No sabes cuándo hacer un cambio de marca o qué dirección tomar con los elementos visuales? **Involucra a tu audiencia en estas decisiones.** Pide a los usuarios su opinión sobre lo que les gusta y deja que voten sobre los elementos visuales de tu canal a través de la pestaña Publicaciones y los Shorts.
...
[Publicar en la comunidad de ayuda   Obtener respuestas de los miembros de la comunidad](/youtube/community?hl=es&help_center_link=CIC2lgYSOENvbnNlam9zIHNvYnJlIGVsIGJhbm5lciBkZWwgY2FuYWwgeSBsYSBpbWFnZW4gZGUgcGVyZmls)
